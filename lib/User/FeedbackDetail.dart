...
import '../UserShared/FeedbackFetchList.dart';
...
class MyFeedbackDetail extends StatefulWidget
{
...
class MyDashboardview1 extends State
{
  ...
  Future<List<FeedbackFetchList>> getRequest() async {
    ...
    var link = ed.geturl1()+"GetFeedback";
  ...
  for(int j=0;j<kk.length;j++)
    {
      FeedbackFetchList user = FeedbackFetchList(
         Name : kk[j]['name'],
          Save_Date: kk[j]['save_date'],
          id: kk[j]['id']
      );
      users.add(user);
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Suggestions & Feedback Detail",style: TextStyle(fontSize: 16),),
        actions: [
          IconButton(
            onPressed: () {
                          ...
                          Card(
                            child:  InkWell(
                                ...
                                child:ListTile(
                                  ...
                                  title: Text("Save Date: "+snapshot.data[index].Save_Date),
                                  subtitle: Text(
                                      "Description: "+snapshot.data[index].Name.toString()
