...
import 'package:sjvn/User/contact_form_item_widget_20.dart';
import 'package:sjvn/User/contact_form_item_widget_21.dart';
...
class MyMedicalClaimForm_2 extends StatefulWidget
{

  final String? text;
  final String? text1;
  MyMedicalClaimForm_2({Key? key, this.text,this.text1}) : super(key: key);
  @override
  createState()=>MyDashboardview1();
}
class MyDashboardview1 extends State<MyMedicalClaimForm_2>
{
  ...
  // showWidget1==true?
  // showEdit==false?
  List<ContactFormItemWidget_21> contactForms = [];
  List<ContactFormItemWidget_20> contactForms1 = [];
...
txt_code.text="Hospitalization Reimbursement";
             var inputformat = DateFormat('dd.MM.yyyy');
             if(widget.text1==null)
               {
                 txt_date.text=inputformat.format(DateTime.now());
               }
             else
               {
         ...
         // contactForms1.clear();
          ...
          for(int k=0;k<parsedList.length;k++)
          {
           ...
           txt_comment.text=parsedList[k]["COMMENT_RETIREE"].toString();
            ...
            print("object_json"+parsedList.length.toString());
            ContactModel1 _contactModel = ContactModel1(id: contactForms1.length);
            contactForms1.add(ContactFormItemWidget_20(
              index:txt_code.text ,
        ...
        else
        {
          ...
          //  txt_comment2.text=parsedList1[k]["COMMENT_FINANCE2"].toString();
            ...
            contactForms.add(ContactFormItemWidget_21(
              index:txt_code.text ,
              contactModel: _contactModel,
    ...
    setState(() {
      try
      {
        ...
        contactForms.add(ContactFormItemWidget_21(
          ...
          CARD_N:"".toString() ,
          HOSPITAL: "".toString(),
          HOSPITAL_TYP: "".toString(),
          CONSULT_DATe: "".toString(),


          PATIENT_NAM: "".toString(),


          APPROVED_CONSULTATION_CHARGe: "".toString(),
          APPROVED_MEDI_COSt:"".toString(),
          APPROVED_PATH_CHARGe:"".toString(),
          CASH_MEMO_DATe: "".toString(),
          CASH_MEMO_no: "".toString(),
          CLAIMED_CONSULTATION_CHARGe: "".toString(),
          CLAIMED_MEDI_COSt: "".toString(),
          CLAIMED_PATH_CHARGe: "".toString(),
          CLAIMED_INJECT_CHARGe:"".toString(),
          APPROVED_INJECT_CHARGe:"".toString(),
        ));
      }
      on Exception catch (_) {
...
PATIENT_NAM: "",
          HOSPITAL_TYP: "",
          TREATMENT: "",
          CLAIMED_SURGICAL_CHARGE: "0",
          CLAIMED_ROOM_CHARGE: "0",
          CLAIMED_OTHER_CHARGE: "0",
          APPROVED_OTHER_CHARGE: "0",
          CLAIMED_COST_OF_MEDICIN: "0",
          APPROVED_ROO: "0",
          APPROVED_COST_OF_MEDICIN: "0",
          HOSPITAL: "",
          applying: "",
          APPROVED_SURGICAL_CHARGE: "0",
          CARD_N: "",
          DATE_FRO: "",
          DATE_T: "",
          crt_visible: true,
