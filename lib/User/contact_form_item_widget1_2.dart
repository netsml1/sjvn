...
class ContactFormItemWidget1_2 extends StatefulWidget {
  ContactFormItemWidget1_2(
      {Key? key, required this.contactModel, required this.onRemove, this.index,this.crt_visible,this.applying,this.HOSPITAL,
        this.HOSPITAL_TYP,
        this.TREATMENT,
         this.DATE_FRO,this.DATE_T,
         this.CLAIMED_ROOM_CHARGE,
        this.APPROVED_ROO,
        this.CLAIMED_OTHER_CHARGE,
        this.APPROVED_OTHER_CHARGE,
        this.CLAIMED_COST_OF_MEDICIN,
        this.APPROVED_COST_OF_MEDICIN,
        this.CLAIMED_SURGICAL_CHARGE,
        this.APPROVED_SURGICAL_CHARGE,
        this.CARD_N,
        this.PATIENT_NAM,
      })
      : super(key: key);
  ...
  String? DATE_FRO="";
      String? DATE_T="";
  String? CLAIMED_ROOM_CHARGE="";
      String? APPROVED_ROO="";
  String? CLAIMED_OTHER_CHARGE="";
      String? APPROVED_OTHER_CHARGE="";
  String? CLAIMED_COST_OF_MEDICIN="";
      String? APPROVED_COST_OF_MEDICIN="";
  String? CLAIMED_SURGICAL_CHARGE="";
      String? APPROVED_SURGICAL_CHARGE="";
      String? CARD_N="";
String? PATIENT_NAM="";
...
class _ContactFormItemWidgetState extends State<ContactFormItemWidget1_2> {
  @override
  ...
  getRequest(String year) async {
    ...
    //print("object_bb"+'{"method" : "selfdependentdetails", "userid" : "Puserid","fiscalyear":"paas_year"}'.replaceAll("Puserid", UserSharedPreferences.getUsername().toString()).replaceAll("paas_year", year.toString()));
    var link = ed.geturl();
    ...
    print("object_bb"+response.statusCode.toString());
    if (response.statusCode == 200) {
     ...
     // var responseData1 = json.decode(data1);
      print("object_bb"+widget.contactModel.APPLYING_FOR.toString());
     // _menuItems!.clear();
      if(widget.APPLYING_FORController.text!="Self")
        {

          final List parsedList = responseData["dependent"];

          kk=  parsedList.where((element) => element["DEP_ID_STR"]==widget.APPLYING_FORController.text).toList();

//productlistddlKey.currentState!.reset();
//print("object_"+kk![0]["NAME"]);
      ...
      print("object_paas"+_menuItems!.length.toString());
...
if(widget.applying!="")
  {
    ...
    setState(() {
      ...
      widget.APPLYING_FORController.text=widget.applying.toString();
      widget.contactModel.APPLYING_FOR=widget.applying.toString();


     // productlistddlKey.currentState?.reset();
      widget.HOSPITAL_NAMEController.text=widget.HOSPITAL.toString();
      widget.contactModel.HOSPITAL_NAME=widget.HOSPITAL.toString();
      widget.HOSPITAL_TYPEController.text=widget.HOSPITAL_TYP.toString();
      widget.contactModel.HOSPITAL_TYPE=widget.HOSPITAL_TYP.toString();

      widget.CARD_NOController.text=widget.CARD_N.toString();
      widget.contactModel.CARD_NO=widget.CARD_N.toString();

      widget.PATIENT_NAMEController.text=widget.PATIENT_NAM.toString();
      widget.contactModel.PATIENT_NAME=widget.PATIENT_NAM.toString();

      widget.TREATMENT_STATUSController.text=widget.TREATMENT.toString();
     widget.contactModel.TREATMENT_STATUS=widget.TREATMENT.toString();
widget.DATE_FROMController.text=widget.DATE_FRO.toString();
widget.contactModel.DATE_FROM=widget.DATE_FRO.toString();
widget.DATE_TOController.text=widget.DATE_T.toString();
widget.contactModel.DATE_TO=widget.DATE_T.toString();
widget.CLAIMED_ROOM_CHARGESController.text=widget.CLAIMED_ROOM_CHARGE.toString();
widget.contactModel.CLAIMED_ROOM_CHARGES=widget.CLAIMED_ROOM_CHARGE.toString();
      widget.APPROVED_ROOM_CHARGESController.text=widget.APPROVED_ROO.toString();
      widget.contactModel.APPROVED_ROOM_CHARGES=widget.APPROVED_ROO.toString();

      widget.CLAIMED_OTHER_CHARGESController.text=widget.CLAIMED_OTHER_CHARGE.toString();
      widget.contactModel.CLAIMED_OTHER_CHARGES=widget.CLAIMED_OTHER_CHARGE.toString();

      widget.APPROVED_OTHER_CHARGESController.text=widget.APPROVED_OTHER_CHARGE.toString();
      widget.contactModel.APPROVED_OTHER_CHARGES=widget.APPROVED_OTHER_CHARGE.toString();

       widget.CLAIMED_COST_OF_MEDICINEController.text=widget.CLAIMED_COST_OF_MEDICIN.toString();
       widget.contactModel.CLAIMED_COST_OF_MEDICINE==widget.CLAIMED_COST_OF_MEDICIN.toString();

      widget.APPROVED_COST_OF_MEDICINEController.text=widget.APPROVED_COST_OF_MEDICIN.toString();
      widget.contactModel.APPROVED_COST_OF_MEDICINE=widget.APPROVED_COST_OF_MEDICIN.toString();

      widget.CLAIMED_SURGICAL_CHARGESController.text=widget.CLAIMED_SURGICAL_CHARGE.toString();
      widget.contactModel.CLAIMED_SURGICAL_CHARGES=widget.CLAIMED_SURGICAL_CHARGE.toString();

       widget.APPROVED_SURGICAL_CHARGESController.text=widget.APPROVED_SURGICAL_CHARGE.toString();
       widget.contactModel.APPROVED_COST_OF_MEDICINE=widget.APPROVED_SURGICAL_CHARGE.toString();
...
// print("object_apply_"+widget.PATIENT_NAMEController.text);
          ...
          child: Container(
            ...
            DropdownButtonFormField(
              ...
              items: <String>['Child', 'Father','Father-in-law','Minor Brother','Mother','Mother-in-law','Self','Spouse','Unmarried sister']
                ...
                TextFormField(
                  readOnly: true,
                  controller: widget.PATIENT_NAMEController,
                  onChanged: (value) => widget.contactModel.PATIENT_NAME = value,
                  onSaved: (value) => widget.contactModel.PATIENT_NAME = value,
                  decoration: InputDecoration(
