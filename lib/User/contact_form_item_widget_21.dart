...
class ContactFormItemWidget_21 extends StatefulWidget {
  ContactFormItemWidget_21(
      {
        Key? key,
        required this.contactModel, required this.onRemove,
        this.index,
        this.crt_visible,
        this.CASH_MEMO_no,
        this.CASH_MEMO_DATe,
...
class _ContactFormItemWidgetState extends State<ContactFormItemWidget_21> {
  ...
  void initState() {
    ...
    if(1==1)
    {
      ...
      getRequest1(DateTime.now().year.toString());
      widget.DOCTOR_NAMEController.text=widget.HOSPITAL.toString();
      widget.contactModel.DOCTOR_NAME=widget.HOSPITAL.toString();
      ...
      widget.CONSULT_DATEController.text=widget.CONSULT_DATe.toString();
      widget.contactModel.CONSULT_DATE=widget.CONSULT_DATe.toString();

      widget.CASH_MEMO_NOController.text=widget.CASH_MEMO_no.toString();
      widget.contactModel.CASH_MEMO_NO=widget.CASH_MEMO_no.toString();

      widget.CASH_MEMO_DATEController.text=widget.CASH_MEMO_DATe.toString();
      widget.contactModel.CASH_MEMO_DATE=widget.CASH_MEMO_DATe.toString();

      widget.GL_CHARGEController.text="280410";
      widget.contactModel.GL="280410";

      widget.CLAIMED_CONSULTATION_CHARGEController.text=widget.CLAIMED_CONSULTATION_CHARGe.toString();
      widget.contactModel.CLAIMED_CONSULTATION_CHARGE=widget.CLAIMED_CONSULTATION_CHARGe.toString();
      widget.APPROVED_CONSULTATION_CHARGEController.text=widget.APPROVED_CONSULTATION_CHARGe.toString();
      widget.contactModel.APPROVED_CONSULTATION_CHARGE=widget.APPROVED_CONSULTATION_CHARGe.toString();

      widget.CLAIMED_INJECT_CHARGEController.text=widget.CLAIMED_INJECT_CHARGe.toString();
      widget.contactModel.CLAIMED_INJECT_CHARGE=widget.CLAIMED_INJECT_CHARGe.toString();
      widget.APPROVED_INJECT_CHARGEController.text=widget.APPROVED_INJECT_CHARGe.toString();
      widget.contactModel.APPROVED_INJECT_CHARGE=widget.APPROVED_INJECT_CHARGe.toString();

      widget.CLAIMED_MEDI_COSTController.text=widget.CLAIMED_MEDI_COSt.toString();
      widget.contactModel.CLAIMED_MEDI_COST=widget.CLAIMED_MEDI_COSt.toString();
      widget.APPROVED_MEDI_COSTController.text=widget.APPROVED_MEDI_COSt.toString();
      widget.contactModel.APPROVED_MEDI_COST=widget.APPROVED_MEDI_COSt.toString();

      widget.CLAIMED_PATH_CHARGEController.text=widget.CLAIMED_PATH_CHARGe.toString();
      widget.contactModel.CLAIMED_PATH_CHARGE=widget.CLAIMED_PATH_CHARGe.toString();
      widget.APPROVED_PATH_CHARGEController.text=widget.APPROVED_PATH_CHARGe.toString();
      widget.contactModel.APPROVED_PATH_CHARGE=widget.APPROVED_PATH_CHARGe.toString();
//print("object_ckh"+widget.TREATMENT.toString());
